...
X_test_input=np.loadtxt("data/ETT72_test_input.txt",delimiter=",") # 读入的时候也需要指定逗号分隔
X_test_target=np.loadtxt("data/ETT72_test_target.txt",delimiter=",") # 读入的时候也需要指定逗号分隔
# test_bkp=np.loadtxt("data/test_bkp.txt",delimiter=",") # 读入的时候也需要指定逗号分隔
